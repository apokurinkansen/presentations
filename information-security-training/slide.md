...
|:---:|:---:|:---:|
| フィッシング等で従業員のアカウント情報を窃取 | 社内ネットワークに侵入 | **データ窃取＋暗号化** |
...
### 原因
フィッシング等で従業員のアカウント情報が窃取され、社内ネットワークに侵入された
...
| Step 1 → | Step 2 → | Step 3 |
|:---:|:---:|:---:|
| リモートアクセス機器から不正侵入 | サーバー内ファイルを暗号化 | **約154万人分の情報漏洩の可能性** |

8月29日に検知し、即日サーバー停止・ネットワーク遮断。10月1日に復旧完了。
...
| Step 1 → | Step 2 → | Step 3 |
|:---:|:---:|:---:|
| 偵察アクセス（4/8〜9） | 管理者画面に不正ログイン | **バックドア設置・データ窃取** |
